    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categoria', models.CharField(choices=[('ACAO', 'Ação'), ('COMEDIA', 'Comédia'), ('DRAMA', 'Drama'), ('TERROR', 'Terror'), ('SCIFI', 'Ficção Científica'), ('DOCUMENTARIO', 'Documentário'), ('AVENTURA', 'Aventura')], max_length=15)),
